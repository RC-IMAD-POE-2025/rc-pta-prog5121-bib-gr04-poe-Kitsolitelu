...
public class RegistrationLoginTest {
    ...
    private static final String VALID_FIRST_NAME = "Kitso";
    private static final String VALID_LAST_NAME = "Litelu";
    ...
    private static final String LOGIN_SUCCESS = "Welcome Kitso Litelu,\nit is great to see you.";

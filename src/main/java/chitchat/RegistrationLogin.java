...
public class RegistrationLogin {
     ...
     * @param newUserName The username to validate and store
     * @param newPassword The password to validate and store
     * @param newCellPhoneNumber The cellphone number to validate and store
     * @param newFirstName The first name to validate and store
     * @param newLastName The last name to validate and store
